...
// Type: VIBlend.WinForms.DataGridView.GroupHeaderDragCancelEventArgs
...
{
  public class GroupHeaderDragCancelEventArgs : CancelEventArgs
  {
    ...
    public GroupHeaderDragCancelEventArgs(DataGridGroupHeaderItem headerItem)
    {
