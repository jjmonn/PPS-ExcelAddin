...
// Type: VIBlend.WinForms.DataGridView.TextBoxEditor
...
{
  /// <summary>
  /// Represents a TextBoxEditor used in the GridView control
  /// </summary>
  [ToolboxItem(false)]
  public class TextBoxEditor : vTextBox, IEditor
  {
