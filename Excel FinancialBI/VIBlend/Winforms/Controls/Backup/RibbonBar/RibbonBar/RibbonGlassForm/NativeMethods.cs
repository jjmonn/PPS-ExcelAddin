...
namespace VIBlend.WinForms.Controls
{
  public static class WindowsAPI
  {
    ...
    public static void DrawTextOnGlass(IntPtr hwnd, string text, Font font, Rectangle ctlrct, int iglowSize)
    {
      ...
      try
      {
        WindowsAPI.DrawThemeTextEx(new VisualStyleRenderer(VisualStyleElement.Window.Caption.Active).Handle, compatibleDc, 0, 0, text, -1, dwFlags, ref pRect, ref new WindowsAPI.DTTOPTS()
        {
