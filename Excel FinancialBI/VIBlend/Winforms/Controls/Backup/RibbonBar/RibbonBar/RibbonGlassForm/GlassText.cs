...
namespace VIBlend.WinForms.Controls
{
  internal class RibbonTextRenderer
  {
    ...
    public void DrawTextOnGlass(IntPtr hwnd, string text, Font font, Rectangle ctlrct, int iglowSize)
    {
      ...
      try
      {
        RibbonTextRenderer.DrawThemeTextEx(new VisualStyleRenderer(VisualStyleElement.Window.Caption.Active).Handle, compatibleDc, 0, 0, text, -1, dwFlags, ref pRect, ref new RibbonTextRenderer.DTTOPTS()
        {
