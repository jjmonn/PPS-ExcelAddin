...
// Type: VIBlend.WinForms.Controls.DrawExplorerBarEventArgs
...
{
  public class DrawExplorerBarEventArgs : EventArgs
  {
    private Graphics g;
    ...
    public vExplorerBarItemHeader Header
    {
      get
      {
        return this.header;
    ...
    public DrawExplorerBarEventArgs(Graphics g, ControlState state, vExplorerBarItemHeader header)
    {
      this.header = header;
      this.g = g;
      this.state = state;
