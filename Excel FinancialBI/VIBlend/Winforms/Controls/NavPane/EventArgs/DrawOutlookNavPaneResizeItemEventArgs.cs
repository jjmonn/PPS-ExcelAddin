...
// Type: VIBlend.WinForms.Controls.DrawOutlookNavPaneResizeItemEventArgs
...
{
  public class DrawOutlookNavPaneResizeItemEventArgs : EventArgs
  {
    private Graphics g;
    private ControlState state;
    private vOutlookResizeItem resizeItem;
    ...
    public DrawOutlookNavPaneResizeItemEventArgs(Graphics g, ControlState state, vOutlookResizeItem resizeItem)
    {
