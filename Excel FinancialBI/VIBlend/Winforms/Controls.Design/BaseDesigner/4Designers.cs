...
// Type: VIBlend.WinForms.Controls.Design.vListControlDesignerBase
...
{
  public class vListControlDesignerBase : vDesignerBase
  {
    ...
    public override DesignerActionListCollection ActionLists
    {
      get
      {
        ...
        vListItemsActionList listItemsActionList = new vListItemsActionList(this.Control);
        actionListCollection.Add((DesignerActionList) listItemsActionList);
