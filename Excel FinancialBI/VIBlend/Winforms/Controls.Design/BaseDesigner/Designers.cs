...
// Type: VIBlend.WinForms.Controls.Design.vDateTimeDesignerBase
...
{
  public class vDateTimeDesignerBase : vDesignerBase
  {
    ...
    public override DesignerActionListCollection ActionLists
    {
      get
      {
        ...
        vDateTimePickerActionList pickerActionList = new vDateTimePickerActionList(this.Control);
        actionListCollection.Add((DesignerActionList) pickerActionList);
