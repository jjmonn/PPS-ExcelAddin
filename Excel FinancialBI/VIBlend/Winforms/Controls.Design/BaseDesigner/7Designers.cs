...
// Type: VIBlend.WinForms.Controls.Design.vOptionsFieldSetDesignerBase
...
{
  public class vOptionsFieldSetDesignerBase : vDesignerBase
  {
    ...
    public override DesignerActionListCollection ActionLists
    {
      get
      {
        ...
        vRadioButtonsActionList buttonsActionList = new vRadioButtonsActionList(this.Control);
        actionListCollection.Add((DesignerActionList) buttonsActionList);
