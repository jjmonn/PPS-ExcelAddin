...
// Type: VIBlend.WinForms.Controls.Design.vFieldSetDesignerBase
...
{
  public class vFieldSetDesignerBase : vDesignerBase
  {
    ...
    public override DesignerActionListCollection ActionLists
    {
      get
      {
        ...
        vCheckBoxesActionList checkBoxesActionList = new vCheckBoxesActionList(this.Control);
        actionListCollection.Add((DesignerActionList) checkBoxesActionList);
