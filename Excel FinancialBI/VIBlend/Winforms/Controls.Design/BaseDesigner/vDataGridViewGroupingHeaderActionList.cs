...
// Type: VIBlend.WinForms.Controls.Design.vDataGridViewGroupingHeaderActionList
...
{
  public class vDataGridViewGroupingHeaderActionList : DesignerActionList
  {
    public vDataGridViewGroupsHeader ControlBase
    {
      get
      {
        return this.Component as vDataGridViewGroupsHeader;
      }
    }
    ...
    public vDataGridViewGroupingHeaderActionList(Control ctrl)
