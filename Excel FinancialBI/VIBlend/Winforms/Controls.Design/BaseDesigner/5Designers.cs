...
// Type: VIBlend.WinForms.Controls.Design.vTrackControlsDesignerBase
...
{
  public class vTrackControlsDesignerBase : vDesignerBase
  {
    ...
    public override DesignerActionListCollection ActionLists
    {
      get
      {
        ...
        vTrackControlsActionList controlsActionList = new vTrackControlsActionList(this.Control);
        actionListCollection.Add((DesignerActionList) controlsActionList);
