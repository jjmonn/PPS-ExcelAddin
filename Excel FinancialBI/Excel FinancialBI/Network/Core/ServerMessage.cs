...
namespace FBI.Network
{
  public enum ServerMessage : int
  {
    ...
    SMSG_CREATE_CHART_ANSWER,
    SMSG_READ_CHART_ANSWER,
    SMSG_UPDATE_CHART_ANSWER,
    SMSG_DELETE_CHART_ANSWER,
    SMSG_LIST_CHART_ANSWER,
    SMSG_CRUD_CHART_LIST_ANSWER,

    SMSG_CREATE_CHART_PANEL_ANSWER,
    SMSG_READ_CHART_PANEL_ANSWER,
    SMSG_UPDATE_CHART_PANEL_ANSWER,
    SMSG_DELETE_CHART_PANEL_ANSWER,
    SMSG_LIST_CHART_PANEL_ANSWER,
    SMSG_CRUD_CHART_PANEL_LIST_ANSWER,

    SMSG_CREATE_CHART_ACCOUNT_ANSWER,
    SMSG_READ_CHART_ACCOUNT_ANSWER,
    SMSG_UPDATE_CHART_ACCOUNT_ANSWER,
    SMSG_DELETE_CHART_ACCOUNT_ANSWER,
    SMSG_LIST_CHART_ACCOUNT_ANSWER,
    SMSG_CRUD_CHART_ACCOUNT_LIST_ANSWER,

    SMSG_AXIS_CONFIGURATION_LIST,
