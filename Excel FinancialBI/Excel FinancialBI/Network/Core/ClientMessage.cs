...
namespace FBI.Network
{
  public enum ClientMessage : ushort
  {
    ...
    CMSG_CREATE_GROUP,
    CMSG_UPDATE_GROUP,
    CMSG_ADD_USER_ENTITY,
    CMSG_DEL_USER_ENTITY,
    CMSG_LIST_GROUPS,
    CMSG_LIST_USERS,
    CMSG_UPDATE_USER,
    ...
    CMSG_CREATE_COMMIT,
    CMSG_GET_FACT,
    CMSG_READ_AXIS_OWNER,
    CMSG_UPDATE_AXIS_OWNER,
    CMSG_LIST_AXIS_OWNER,
    CMSG_CRUD_AXIS_OWNER,
    CMSG_CREATE_AXIS_OWNER,
    CMSG_GET_COMMIT_LOG,
    CMSG_GET_AXIS_ELEM_LOG,
    CMSG_READ_FACT_TAG,
    CMSG_UPDATE_FACT_TAG,
    CMSG_LIST_FACT_TAG,
    CMSG_CRUD_FACT_TAG,
    CMSG_CREATE_FACT_TAG,
    CMSG_UPDATE_LEGAL_HOLIDAY,
    CMSG_LIST_LEGAL_HOLIDAY,
    CMSG_CRUD_LEGAL_HOLIDAY,
    CMSG_CREATE_LEGAL_HOLIDAY,
    CMSG_DELETE_LEGAL_HOLIDAY,
    CMSG_DELETE_FACT_TAG,
    CMSG_CREATE_CHART,
    CMSG_UPDATE_CHART,
    CMSG_DELETE_CHART,
    CMSG_LIST_CHART,
    CMSG_CRUD_CHART_LIST,
    CMSG_CREATE_CHART_PANEL,
    CMSG_UPDATE_CHART_PANEL,
    CMSG_DELETE_CHART_PANEL,
    CMSG_LIST_CHART_PANEL,
    CMSG_CRUD_CHART_PANEL_LIST,
    CMSG_CREATE_CHART_ACCOUNT,
    CMSG_UPDATE_CHART_ACCOUNT,
    CMSG_DELETE_CHART_ACCOUNT,
    CMSG_LIST_CHART_ACCOUNT,
    CMSG_CRUD_CHART_ACCOUNT_LIST,
    OpcodeMax
  }
}