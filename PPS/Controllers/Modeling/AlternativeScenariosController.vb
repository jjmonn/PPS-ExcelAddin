...
'    Private GDFSUEZASExports As New AlternativeScenarioExport
...
'        reports_settings_dic(report_node.Name)(name_variable) = reports_settings_dic(report_node.Name)(name_variable) & " Base Scenario"
'        reports_settings_dic(report_node.Name)(name_variable) = reports_settings_dic(report_node.Name)(name_variable) & " New Scenario"
...
'            If Not IsDBNull(reports_settings_dic(serie_node.Name)(account_id_variable)) Then
'                Dim serie_account_id = reports_settings_dic(serie_node.Name)(account_id_variable)
'                base_chart.Series(reports_settings_dic(serie_node.Name)(name_variable)).Points.DataBindXY(charts_periods, Model.current_conso_data_dic(entity_id)(serie_account_id))
'                new_chart.Series(reports_settings_dic(serie_node.Name)(name_variable)).Points.DataBindXY(charts_periods, new_scenario_data(serie_account_id))
'            End If
'        Next
'        View.AddCharts(base_chart, new_chart) ' , new_chart, reports_settings_dic(report_node.Name)(name_variable))
...
'            If Not IsDBNull(reports_settings_dic(serie_node.Name)(account_id_variable)) Then
'                Dim serie_account_id = reports_settings_dic(serie_node.Name)(account_id_variable)
'                Dim serie_name = reports_settings_dic(serie_node.Name)(name_variable)
...
'        View.AddDGV(DGV) 'reports_settings_dic(report_node.Name)(name_variable))
