...
Module DataTables_Functions
    ...
    Public Function BuildHeadersTable(HeadersArray As Collections.Generic.Dictionary(Of String, String), _
                                     RowsArray As Collections.Generic.Dictionary(Of String, String)) _
                                     As Data.DataTable

        '---------------------------------------------------------------------------------
        ' Return a DataTable (DataBase format) from Headers, 1st column, data = "" 
        '---------------------------------------------------------------------------------
        Dim i As Integer = 0
        Dim table As New Data.DataTable
