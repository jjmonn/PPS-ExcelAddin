...
#Region "Interface"
    ...
    Friend Sub StubDemosFormatting_ThreadSafe()
        ...
        If InvokeRequired Then
            ...
            Me.Invoke(MyDelegate, New Object() {})
        Else
            If My.Settings.chart1Serie1AccountId <> 0 Then ChartsUtilities.FormatSerie(Chart1.Series(GlobalVariables.Accounts.GetAccount(My.Settings.chart1Serie1AccountId).Name), My.Settings.chart1Serie1Color, My.Settings.chart1Serie1Type)
            If My.Settings.chart1Serie2AccountId <> 0 Then ChartsUtilities.FormatSerie(Chart1.Series(GlobalVariables.Accounts.GetAccount(My.Settings.chart1Serie2AccountId).Name), My.Settings.chart1Serie2Color, My.Settings.chart1Serie2Type)
            If My.Settings.chart2Serie1AccountId <> 0 Then ChartsUtilities.FormatSerie(Chart2.Series(GlobalVariables.Accounts.GetAccount(My.Settings.chart2Serie1AccountId).Name), My.Settings.chart2Serie1Color, My.Settings.chart2Serie1Type, , 22)
            If My.Settings.chart2Serie2AccountId <> 0 Then ChartsUtilities.FormatSerie(Chart2.Series(GlobalVariables.Accounts.GetAccount(My.Settings.chart2Serie2AccountId).Name), My.Settings.chart2Serie2Color, My.Settings.chart2Serie2Type)
            If My.Settings.chart3Serie1AccountId <> 0 Then ChartsUtilities.FormatSerie(Chart3.Series(GlobalVariables.Accounts.GetAccount(My.Settings.chart3Serie1AccountId).Name), My.Settings.chart3Serie1Color, My.Settings.chart3Serie1Type, , 22)
            If My.Settings.chart3Serie2AccountId <> 0 Then ChartsUtilities.FormatSerie(Chart3.Series(GlobalVariables.Accounts.GetAccount(My.Settings.chart3Serie2AccountId).Name), My.Settings.chart3Serie2Color, My.Settings.chart3Serie2Type, 100)
            If My.Settings.chart4Serie1AccountId <> 0 Then ChartsUtilities.FormatSerie(Chart4.Series(GlobalVariables.Accounts.GetAccount(My.Settings.chart4Serie1AccountId).Name), My.Settings.chart4Serie1Color, My.Settings.chart4Serie1Type, 100)
            If My.Settings.chart4Serie1AccountId <> 0 Then ChartsUtilities.FormatSerie(Chart4.Series(GlobalVariables.Accounts.GetAccount(My.Settings.chart4Serie1AccountId).Name), My.Settings.chart4Serie2Color, My.Settings.chart4Serie2Type, 100)
        End If
