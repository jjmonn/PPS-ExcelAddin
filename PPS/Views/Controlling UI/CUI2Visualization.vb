...
#Region "Interface"
    ...
    Friend Sub StubDemosFormatting_ThreadSafe()
        ...
        If InvokeRequired Then
            ...
            Me.Invoke(MyDelegate, New Object() {})
        Else
            If GlobalVariables.Accounts.m_accountsHash.ContainsKey(My.Settings.chart1Serie1AccountId) <> 0 Then ChartsUtilities.FormatSerie(Chart1.Series(GlobalVariables.Accounts.m_accountsHash(My.Settings.chart1Serie1AccountId)(NAME_VARIABLE)), My.Settings.chart1Serie1Color, My.Settings.chart1Serie1Type)
            If GlobalVariables.Accounts.m_accountsHash.ContainsKey(My.Settings.chart1Serie2AccountId) <> 0 Then ChartsUtilities.FormatSerie(Chart1.Series(GlobalVariables.Accounts.m_accountsHash(My.Settings.chart1Serie2AccountId)(NAME_VARIABLE)), My.Settings.chart1Serie2Color, My.Settings.chart1Serie2Type)
            If GlobalVariables.Accounts.m_accountsHash.ContainsKey(My.Settings.chart2Serie1AccountId) <> 0 Then ChartsUtilities.FormatSerie(Chart2.Series(GlobalVariables.Accounts.m_accountsHash(My.Settings.chart2Serie1AccountId)(NAME_VARIABLE)), My.Settings.chart2Serie1Color, My.Settings.chart2Serie1Type, , 22)
            If GlobalVariables.Accounts.m_accountsHash.ContainsKey(My.Settings.chart2Serie2AccountId) <> 0 Then ChartsUtilities.FormatSerie(Chart2.Series(GlobalVariables.Accounts.m_accountsHash(My.Settings.chart2Serie2AccountId)(NAME_VARIABLE)), My.Settings.chart2Serie2Color, My.Settings.chart2Serie2Type)
            If GlobalVariables.Accounts.m_accountsHash.ContainsKey(My.Settings.chart3Serie1AccountId) <> 0 Then ChartsUtilities.FormatSerie(Chart3.Series(GlobalVariables.Accounts.m_accountsHash(My.Settings.chart3Serie1AccountId)(NAME_VARIABLE)), My.Settings.chart3Serie1Color, My.Settings.chart3Serie1Type, , 22)
            If GlobalVariables.Accounts.m_accountsHash.ContainsKey(My.Settings.chart3Serie2AccountId) <> 0 Then ChartsUtilities.FormatSerie(Chart3.Series(GlobalVariables.Accounts.m_accountsHash(My.Settings.chart3Serie2AccountId)(NAME_VARIABLE)), My.Settings.chart3Serie2Color, My.Settings.chart3Serie2Type, 100)
            If GlobalVariables.Accounts.m_accountsHash.ContainsKey(My.Settings.chart4Serie1AccountId) <> 0 Then ChartsUtilities.FormatSerie(Chart4.Series(GlobalVariables.Accounts.m_accountsHash(My.Settings.chart4Serie1AccountId)(NAME_VARIABLE)), My.Settings.chart4Serie1Color, My.Settings.chart4Serie1Type, 100)
            If GlobalVariables.Accounts.m_accountsHash.ContainsKey(My.Settings.chart4Serie1AccountId) <> 0 Then ChartsUtilities.FormatSerie(Chart4.Series(GlobalVariables.Accounts.m_accountsHash(My.Settings.chart4Serie1AccountId)(NAME_VARIABLE)), My.Settings.chart4Serie2Color, My.Settings.chart4Serie2Type, 100)
        End If
