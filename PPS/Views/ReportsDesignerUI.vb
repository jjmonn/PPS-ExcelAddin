...
#Region "Initialize"
    ...
    Protected Friend Sub New(ByRef input_controller As ReportsDesignerController, _
        ...
        ht.Add(name_variable, "Chart Preview")
...
#Region "Display"
    ...
    Private Sub DisplaySerieData(ByRef serie_id As String)
        ...
        If serie_id <> "" Then
            ...
            If Not IsDBNull(ht(account_id_variable)) Then ItemCB.Text = accounts_id_name_dic(ht(account_id_variable)) Else ItemCB.Text = ""
    ...
    Private Sub DisplayReportOptions(ByRef report_id As String)
        ...
        isDisplayingSerie = True
        If Not IsDBNull(ht(name_variable)) Then ReportNameTB.Text = ht(name_variable) Else ReportNameTB.Text = ""
