...
'        Dim typesDict As Hashtable = globalvariables.accounts.GetAccountsDictionary(ID_VARIABLE, ACCOUNT_TYPE_VARIABLE)
'        Dim conversion_flagDict As Hashtable = globalvariables.accounts.GetAccountsDictionary(ID_VARIABLE, ACCOUNT_CONVERSION_OPTION_VARIABLE)
...
'        Dim entities_id_currencies_dic As Hashtable = EntitiesMapping.GetEntitiesDictionary(ID_VARIABLE, ENTITIES_CURRENCY_VARIABLE)
