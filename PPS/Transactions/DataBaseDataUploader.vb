...
#Region "Interface"
    ...
    Protected Friend Sub SetUpDictionaries(ByRef input_entities_name_id_Dic As Hashtable, _
        ...
        VersionsNameTableAddressDictionary = GlobalVariables.Versions.GetVersionsDictionary(NAME_VARIABLE, ID_VARIABLE)
...
#Region "Upload a single Value"
    ...
    Protected Friend Function UpdateSingleValue(ByRef entityKey As String, _
