    ...
    Private Function VersionsIdentify() As Boolean
        ...
        For i = LBound(GlobalScreenShot, 1) To UBound(GlobalScreenShot, 1)
            For j = LBound(GlobalScreenShot, 2) To UBound(GlobalScreenShot, 2)
                If versionsNameList.Contains(CStr(GlobalScreenShot(i, j))) 
...
#Region " Output/ Input Data Processing functions"
    ...
    Friend Sub UpdateExcelCell(ByRef entityAddress As String, _
        ...
        cell.Value2 = value
        If OutputCellsAddressValuesDictionary.ContainsKey(cell.Address) Then
            OutputCellsAddressValuesDictionary(cell.Address) = value
        Else
            OutputCellsAddressValuesDictionary.Add(cell.Address, value)
        End If
