...
'    Friend Shared Function CheckFormula(ByVal formula As String, _
'                                                  ByRef token_list As List(Of String)) As Int32

'        Dim operators As List(Of String) = New List(Of String)
'        For Each item In FormulasParser.FORMULAS_TOKEN_CHARACTERS
'            operators.Add(item)
'        Next
...
'        ' formulas syntax checks to be handled in vb
...
'    Friend Shared Function convertTokensToNumericValues(ByVal formula As String, _
'                                                           ByRef token_list As List(Of String), _
'                                                           ByRef operators As List(Of String)) As String

'        Dim i As Integer
'        Dim formula_array As String() = Split(Utilities_Functions.DivideFormula(formula), FormulasTranslations.FORMULA_SEPARATOR)         ' Generate array from formula
