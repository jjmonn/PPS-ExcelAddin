...
#Region "Utilities"
    ...
    Friend Shared Sub GetFilterValueHTFromPacket(ByRef packet As ByteBuffer, ByRef filtervalue_ht As Hashtable)
        ...
        filtervalue_ht(ID_VARIABLE) = packet.ReadInt32()
        filtervalue_ht(FILTER_ID_VARIABLE) = packet.ReadInt32()
        filtervalue_ht(PARENT_FILTER_VALUE_ID_VARIABLE) = packet.ReadInt32()
        filtervalue_ht(NAME_VARIABLE) = packet.ReadString()
        filtervalue_ht(ITEMS_POSITIONS) = packet.ReadInt32()
    ...
    Private Sub WriteFilterValuePacket(ByRef packet As ByteBuffer, ByRef attributes As Hashtable)
        ...
        packet.WriteInt32(attributes(PARENT_FILTER_VALUE_ID_VARIABLE))
        packet.WriteInt32(attributes(PARENT_FILTER_VALUE_ID_VARIABLE))
