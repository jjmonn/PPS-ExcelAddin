...
'Friend Class globalvariables.accounts
...
'        '  srv.OpenRst(GlobalVariables.database + "." + ACCOUNTS_TABLE, ModelServer.FWD_CURSOR)
...
'                tmpList.Add(srv.rst.Fields(NAME_VARIABLE).Value)
'                srv.rst.MoveNext()
'            Loop
'        End If
...
'            srv.rst.MoveFirst()
'            Do While srv.rst.EOF = False
'                tmpList.Add(srv.rst.Fields(ID_VARIABLE).Value)
'                srv.rst.MoveNext()
'            Loop
'        End If
...
'    '    Dim srv = New ModelServer
'    '    '      srv.OpenRst(GlobalVariables.database + "." + ACCOUNTS_TABLE, ModelServer.FWD_CURSOR)
'    '    srv.rst.Filter = ACCOUNT_CONSOLIDATION_OPTION_VARIABLE + "='" + RECOMPUTATION_CODE + "'"
...
'    '            keysTypesFormatsDict.Add(srv.rst.Fields(ID_VARIABLE).Value, tmpDic)
'    '            srv.rst.MoveNext()
'    '        End While
'    '        srv.rst.Close()
'    '        srv = Nothing
...
'    '        srv.rst.Sort = ITEMS_POSITIONS
'    '        Do While srv.rst.EOF = False
'    '            tokensArray(i) = srv.rst.Fields(ID_VARIABLE).Value
'    '            parentsArray(i) = srv.rst.Fields(PARENT_ID_VARIABLE).Value
...
'    '            conversionFlag(i) = srv.rst.Fields(ACCOUNT_CONVERSION_OPTION_VARIABLE).Value
'    '            srv.rst.MoveNext()
'    '            i = i + 1
'    '        Loop
'    '    End If
'    '    accountTableArrays.Add(ID_VARIABLE, tokensArray)
'    '    accountTableArrays.Add(PARENT_ID_VARIABLE, parentsArray)
...
'    '    accountTableArrays.Add(ACCOUNT_CONVERSION_OPTION_VARIABLE, conversionFlag)
...
'        srv.rst.Filter = PARENT_ID_VARIABLE + "=" + "'" + Account + "'"
...
'        srv.rst.MoveFirst()
'        Do While srv.rst.EOF = False
'            ChildrenList.Add(CStr(srv.rst.Fields(ID_VARIABLE).Value))
'            srv.rst.MoveNext()
'        Loop
