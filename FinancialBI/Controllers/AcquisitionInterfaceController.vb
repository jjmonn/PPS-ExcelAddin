...
'                                     entityName, _
'                                     DATASET.m_inputsAccountsList(0), _
...
'        ACQUI.LoadPeriodsToHierarchy(ACQUI.DGV.RowsHierarchy, entityName, DATASET.m_inputsAccountsList(0), ACQUMODEL.currentPeriodList, GlobalVariables.Versions.versions_hash(ACQUMODEL.current_version_id)(VERSIONS_TIME_CONFIG_VARIABLE))
'        ACQUMODEL.downloadDBInputs(entityName, _
'                                   GlobalVariables.ClientsIDDropDown.SelectedItemId, _
'                                   GlobalVariables.ProductsIDDropDown.SelectedItemId, _
'                                   GlobalVariables.AdjustmentIDDropDown.SelectedItemId)
...
'            Dim tuple_ As New Tuple(Of String, String, String)(currentEntity, account.Caption, periodAsInt)
'            If DATASET.DimensionsToCellDictionary.ContainsKey(tuple_) = True Then
'                value = DATASET.DimensionsToCellDictionary(tuple_).Value2
...
'            Dim tuple_ As New Tuple(Of String, String, String)(entity.Caption, account.Caption, period)
'            If DATASET.DimensionsToCellDictionary.ContainsKey(tuple_) = True Then
'                value = DATASET.DimensionsToCellDictionary(tuple_).Value2
'            Else
'                value = 0
...
'                Dim tuple_ As New Tuple(Of String, String, String)(entity.Caption, account, periodsItemIDPeriodCodeDict(period.GetUniqueID))
'                If DATASET.DimensionsToCellDictionary.ContainsKey(tuple_) = True Then
'                    value = DATASET.DimensionsToCellDictionary(tuple_).Value2
'                Else
'                    value = 0
