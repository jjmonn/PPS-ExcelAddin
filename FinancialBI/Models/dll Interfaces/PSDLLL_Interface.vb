...
'    ' Variables
'    Private mEntitiesList As Int32()
...
'                                      <MarshalAs(UnmanagedType.SafeArray, SafeArraySubType:=VarEnum.VT_INT)> ByRef entities_list() As Int32, _
