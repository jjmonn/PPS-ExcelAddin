...
public enum ServerMessage : int
{
  ...
  SMSG_CREATE_AXIS_PARENT_ANSWER,
  SMSG_READ_AXIS_PARENT_ANSWER,
  SMSG_UPDATE_AXIS_PARENT_ANSWER,
  SMSG_DELETE_AXIS_PARENT_ANSWER,
  SMSG_LIST_AXIS_PARENT_ANSWER,
  SMSG_CRUD_AXIS_PARENT_LIST_ANSWER,
