...
namespace FBI.MVC.Model
{
  ...
  class VersionModel : NamedCRUDModel<Version>
  {
    ...
    VersionModel()
    {
      ...
      InitCallbacks();
      NetworkManager.GetInstance().SetCallback((UInt16)CopySMSG, CopyAnswer);
    }

    ~VersionModel()
    {
      NetworkManager.GetInstance().RemoveCallback((UInt16)CopySMSG, CopyAnswer);
    }
